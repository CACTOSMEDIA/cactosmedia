(function ($) {
  $.fn.floatingWhatsApp = function (options) {
    ...
    if (settings.showPopup) {
      ...
      if (settings.avatar) {
        let $avatarInfo =
          '<div class="floating-wpp-avatar-info">' +
          '<div class="floating-wpp-avatar-name">' +
          settings.avatarName +
          "</div>" +
          '<div class="floating-wpp-avatar-role">' +
          settings.avatarRole +
          "</div></div>";
        $header
          .append(
            '<img src="' +
              settings.avatar +
              '" alt="Avatar" class="floating-wpp-avatar">',
            $avatarInfo,
            $closeBtn
          )
